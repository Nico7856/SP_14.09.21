...
namespace SP_14._09._21.Web.Controllers
{
    public class CarrerasController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Descipcion,Tipo_Cur,Fecha,Activo")] Carrera carrera)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Descipcion,Tipo_Cur,Fecha,Activo")] Carrera carrera)
        {
            if (id != carrera.Id)
            {
                return NotFound();
